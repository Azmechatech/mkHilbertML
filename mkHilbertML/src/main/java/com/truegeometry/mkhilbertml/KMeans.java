...
public class KMeans {
    ...
    public void init() {
    	//Create Points
    	points.addAll(Point.createRandomPoints(MIN_COORDINATE,MAX_COORDINATE,NUM_POINTS));
    ...
    public void init(long minX, long maxX,long minY, long maxY,int NUM_CLUSTERS) {
